...
// import excursionLogData from './excursionsData';
...
const getAllExcursions = () => new Promise((resolve, reject) => {
  destinationData.getDestinations()
    .then((destinations) => excursionsData.getExcursionsByDestinations(destinations))
    .then((excursionsWithDestinations) => environmentData.getEnvironmentsByDestinations(excursionsWithDestinations))
    .then((excursions) => {
      console.error('excursionsWithDestinationsWithEnvironments', excursions);
      resolve(excursions);
    })
    .catch((error) => reject(error));
});

// const getExcursionsWithLogs = () => new Promise((resolve, reject) => {
//   const newExcursion = [];
//   getAllExcursions()
//     .then((excursions) => excursionsLogsData.getExcursionsLogs(excursions))
//     .then((excursionLogs) => {
//       excursionLogs.forEach((excursionLog) => {
//         const log = { ...excursionLog };
//         log.
//       });
//       resolve(newExcursion);
//     })
//     .catch((error) => reject(error));
// });
